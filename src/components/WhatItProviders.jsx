  ...
  return (
    <div className="overflow-hidden  marqueWrapperDiv sm:pt-8">
      ...
      <div className="flex justify-center">
        <div
          ref={marqueElement}
          className="marque flex-shrink-0 flex justify-between items-center h-[80px] sm:h-[80px] md:h-[100px] lg:h-[150px] border-2 font-slackey text-[2.3vw] sm:text-[1.5vw] text-[#5a3f3f] py-2 md:py-4 lg:py-8 w-[300%]"
        >

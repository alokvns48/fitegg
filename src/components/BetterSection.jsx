  ...
  return (
    ...
    >
      <div className="pt-24 px-8 sm:px-16 lg:px-24 bg-gradient-to-b from-[#F6F6F6]">
        <h2 className="text-[3vw] text-center lg:text-left font-extrabold font-sans text-[#DA3A3B] ">
          HOW ARE WE BETTER?
        </h2>
        <div className="flex justify-center">
          <div className="flex flex-col sm:flex-row justify-center lg:justify-between items-start lg:items-center pt-8 md:pt-14 lg:pt-20 space-y-4 sm:space-y-0">
            <div className="flex flex-col items-start lg:justify-between lg:items-center  lg:w-auto">
              <h2 className="font-sans font-extrabold text-[#C39132] text-[2vw]  lg:text-center ">
                FIT EGG
              </h2>
              <ol className="flex flex-col justify-between list-decimal font-ubuntu list-inside text-[1.6vw] lg:text-[1.4vw] gap-1 sm:gap-2 mt-2 sm:mt-6 w-full">
            ...
            <div className="flex flex-col justify-between items-start lg:items-center sm:pl-8 w-50% lg:w-auto">
              <h2 className="font-sans font-extrabold text-[#585858] text-[2vw] text-center">
                REGULAR
              </h2>
              <ol className="flex flex-col justify-between items-start list-decimal list-inside font-ubuntu text-[1.6vw] lg:text-[1.4vw] gap-1 sm:gap-2 mt-2 sm:mt-6">
